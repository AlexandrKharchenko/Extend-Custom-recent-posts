...
Tags: custom post types, post types, latest posts, recent posts, sidebar widget, plugin
...
=How do I change the posts number to display?=
The widget uses an input box, simply enter the number of post want to display.
